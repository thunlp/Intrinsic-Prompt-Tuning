...
bsz_list=4
AE_recover_from_path=/home/qinyujia/Intrinsic-Prompt-Tuning/models/adapter_distil_bs256_dim2000_type1_20w_random/best-ckpt.pt
output_dir=models/recover/adapter_all/adapter_distil_bs256_dim1000_type1_20w_random
inherit_prompt_path=/home/qinyujia/CrossFit_prompt/models/few_shot_prompt
intrinsic_dim=2000
AE_loss=0
Distil_loss=1
AE_type=1
...
--do_train \
--train_dir data \
--custom_tasks_splits dataloader/custom_tasks_splits/individual_tasks/${TASK}.json \
